 ...
 */
public class NetConnectBroadcastRecevere extends BroadcastReceiver {
    String doingMsg;
    String endMsg;
    TextView text;
    MainActivity m;
    ...
    public NetConnectBroadcastRecevere(String doingmsg, String endmsg, TextView text, MainActivity m, BroadcastReceiver b){
        super();
