 ...
 */
public class LocationRecever extends BroadcastReceiver {
    String doingMsg;
    String endMsg;
    TextView text; 
    MainActivity m;
    BroadcastReceiver b;
    public  LocationRecever (String doingmsg, String endmsg, TextView text, MainActivity m, BroadcastReceiver b){
        super();
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if(action.equals(BroadcastCountDownService.IN_RUNNING)) {
            ...
            if(m.LocationMessage.equals("NO")||m.LocationMessage.equals("")){
                m.StartLocationCountDown(m.text2);
            }else {
                m.StartSendSMSCountDown(m.text3);
            }
