 ...
 */ 
public class SuccessReveiver extends BroadcastReceiver {
    String doingMsg;
    String endMsg;
    TextView text;
    MainActivity m;
    BroadcastReceiver b;
    public  SuccessReveiver(String doingmsg, String endmsg, TextView text, MainActivity m, BroadcastReceiver b){
        super();
